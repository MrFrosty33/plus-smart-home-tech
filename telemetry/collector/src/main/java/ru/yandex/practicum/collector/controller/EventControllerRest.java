...
public class EventControllerRest {
    ...
    public EventControllerRest(Set<SensorEventHandler> sensorEventHandlers,
    ...
    public void receiveSensorEvent(@RequestBody @Valid SensorEvent sensorEvent) {
        try {
            ...
            throw new UnknownEnumException("Error processing SensorEvent JSON");
        }
    }
    ...
    public void receiveHubEvent(@RequestBody @Valid HubEvent hubEvent) {
        try {
            ...
            throw new UnknownEnumException("Error processing HubEvent JSON");
        }
    }
}
